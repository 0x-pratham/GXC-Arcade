      ...
      >
        {featuresList.map((feature, idx) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-[#5f2396] to-[#a855f7] group-hover:w-full transition-all duration-500 ease-out"></div>
            
            {/* Minimal Header */}
            <div className="mb-8">
              <div className={`inline-flex p-4 rounded-2xl ${feature.bg} ${feature.border} border shadow-inner group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500`}>
