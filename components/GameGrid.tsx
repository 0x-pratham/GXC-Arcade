...
export default function GameGrid({ games, loading }: GameGridProps) {
  // Explicit Variants typing prevents TypeScript from widening
  // animation values such as "spring" to a generic string.
  ...
  return (
    <section
      id="arcade-section"
      className="w-full bg-white flex-1 pt-24 pb-32 rounded-t-[3rem] md:rounded-t-[4rem] shadow-[0_-10px_40px_rgba(199,166,243,0.15)] border-t border-[#c7a6f3]/30 relative z-20"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          <div className="h-1 w-24 bg-gradient-to-r from-[#5f2396] to-[#c7a6f3] rounded-full" />
        </div>

        {loading ? (
          <div className="flex flex-col justify-center items-center py-20 gap-4">
            <div className="w-12 h-12 border-4 border-[#f4effc] border-t-[#5f2396] rounded-full animate-spin" />
          ...
          <div className="text-center py-20 bg-[#f4effc] rounded-[2rem] border border-[#c7a6f3]/50 max-w-2xl mx-auto shadow-inner">
            <p className="text-2xl font-bold text-[#220849] mb-2">
              No Games Found
            </p>

            <p className="text-[#220849]/60 font-medium">
              There are currently no active games available.
            </p>
          </div>
        ) : (
          <motion.div
              ...
              >
                ...
                <div className="p-3 pb-0">
                  <div className="relative h-56 w-full rounded-[1.25rem] overflow-hidden bg-[#f4effc] border border-[#c7a6f3]/20">
                    <div className="absolute inset-0 bg-gradient-to-t from-[#220849]/60 via-transparent to-transparent z-10 opacity-60 group-hover:opacity-20 transition-opacity duration-500" />
                    ...
                    {game.thumbnail_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <span className="text-[#c7a6f3] font-bold text-3xl font-heading opacity-30 z-20">
                          GXC
                        </span>
                      </div>
                    )}
                ...
                <div className="p-6 md:p-8 pt-6 flex flex-col flex-1">
                  ...
                  <p className="text-[#220849]/60 text-sm font-medium leading-relaxed line-clamp-2 mb-8 flex-1">
                    {game.description ||
                      "A premium arcade experience. Ready to play."}
                  </p>
